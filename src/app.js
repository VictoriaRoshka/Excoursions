...
function showTours(tours) {
    ...
    <div class="flex justify-between px-2"><h1 class="font-bold text-xl text-amber-700">${
        tour.hotelName
    }</h1>
  <div class="rating flex"><div class="items-center justify-center text-md font-medium text-justify text-gray-700">${
      tour.rating
  }</div></div></div>
